...
//    func transformArray<U: StoreableValueConvertible, V: StoreableValueConvertible>(fromElementType: U.Type, _ transformer: Array<U>? -> Array<V>?) -> PropertyMigrationType
//    func transformSet<U: StoreableValueConvertible, V: StoreableValueConvertible>(fromElementType: U.Type, _ transformer: Set<U>? -> Set<V>?) -> PropertyMigrationType
//    func transformDictionary<T: StoreableValueConvertible, U: StoreableValueConvertible, V: StoreableValueConvertible, W: StoreableValueConvertible>(fromKeyType: T.Type, andElementType: U.Type, _ transformer: Dictionary<T, U>? -> Dictionary<V, W>?) -> PropertyMigrationType
//    
